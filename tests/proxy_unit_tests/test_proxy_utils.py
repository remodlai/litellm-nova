...
def test_foward_litellm_user_info_to_backend_llm_call():
    ...
    expected_data = {
        "x-remodl-user_api_key_user_id": "test_user_id",
        "x-remodl-user_api_key_org_id": "test_org_id",
        "x-remodl-user_api_key_hash": "test_api_key",
        "x-remodl-user_api_key_spend": 0.0,
        "x-remodl-user_api_key_auth_metadata": {},
    }
