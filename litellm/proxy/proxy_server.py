...
ui_message = (
    f"👉 [```Remodl AI Gateway Proxy Admin Panel on /ui```]({ui_link}). Create, Edit Keys with SSO"
)
ui_message += "\n\n💸 [```Remodl AI Gateway Model Cost Map```](https://models.litellm.ai/)."

ui_message += f"\n\n🔎 [```Remodl AI Gateway Model Hub```]({model_hub_link}). See available models on the proxy. [**Docs**](https://docs.litellm.ai/docs/proxy/model_hub)"
